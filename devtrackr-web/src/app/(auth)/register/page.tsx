...
export default function RegisterPage() {
  ...
  return (
    <main ref={containerRef} className="flex min-h-screen bg-white">
      ...
      {/* Right Panel - Form */}
      <div className="w-full lg:w-[40%] flex flex-col items-center justify-center p-6 sm:p-12 relative overflow-y-auto">
        <div className="w-full max-w-sm lg:hidden flex items-center gap-2 mb-12 text-slate-900 auth-form-container mt-8">
        ...
        <div className="hidden lg:block w-full text-center mt-12 auth-form-container pb-8 text-xs text-muted-foreground font-medium">
